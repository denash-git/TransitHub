...
ENV_FIELDS = [
    ...
    EnvField("DIAG_UPLOAD_BYTES", "67108864", True, "Per-stream diagnostics upload payload size in bytes."),
    EnvField("DIAG_DOWNLOAD_STREAMS", "3", True, "Number of parallel browser download streams."),
    EnvField("DIAG_UPLOAD_STREAMS", "4", True, "Number of parallel browser upload streams."),
    ...
    EnvField("MANAGED_REALITY_INBOUND_ID", "", False, "Managed reality inbound id."),
    EnvField("MANAGED_WS_INBOUND_ID", "", False, "Managed ws inbound id."),
    EnvField("MANAGED_XHTTP_INBOUND_ID", "", False, "Managed xhttp inbound id."),
    EnvField("MANAGED_TROJAN_INBOUND_ID", "", False, "Managed trojan-grpc inbound id."),
]
