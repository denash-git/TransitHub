...
ENV_FIELDS = [
    ...
    EnvField("DIAG_UPLOAD_BYTES", "33554432", True, "Per-stream diagnostics upload payload size in bytes."),
    EnvField("DIAG_DOWNLOAD_STREAMS", "3", True, "Number of parallel browser download streams."),
    EnvField("DIAG_UPLOAD_STREAMS", "3", True, "Number of parallel browser upload streams."),
